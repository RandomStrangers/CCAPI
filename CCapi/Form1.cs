...
namespace CCapi {
    public partial class Form1 : Form {
        ...
        private void tBSearch_GotFocus(object sender, EventArgs e) {
            ...
            if (tBSearch.Text.CaselessEq("Player Name"))
            {
                tBSearch.Text = "";
            }
        }
        ...
        private void bSkinDownload_Click(object sender, EventArgs e) {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://cdn.classicube.net/skin/" + tbUserName.Text + ".png");
            request.Method = "HEAD";
            try {
                request.GetResponse();
        ...
        private void getPlayer() {
            ...
            if (name == "Player Name") 
            {
                MessageBox.Show("Please input a valid username!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            else if (name == "")
            {
        ...
        private Image getAvatar(string name) {
            try {
                ...
                MessageBox.Show("Failed to retrieve face. Player might not have a custom skin!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                // Stream stream = new WebClient().OpenRead("https://cdn.classicube.net/face/default.png");
                //  return Image.FromStream(stream);
                return null;
            }
        }
        private Image getCountry(string name) {
            try {
                ...
                MessageBox.Show("Failed to retrieve country flag. ClassiCube.net might be down!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return null;
            }
        }
        ...
        private void getOverallStats() {
            ...
            try {
               ...
               // MessageBox.Show("Failed to retrieve total number of accounts. ClassiCube.net might be down!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        }
